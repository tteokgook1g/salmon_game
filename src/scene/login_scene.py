...
class LoginScene(Scene):
    ...
    def update(self, key_pressed: Sequence[bool], mouse_pos: Tuple[int, int], mouse_click:Tuple[int,int,int]) -> None:
        ...
        self.id_button.update(key_pressed,mouse_pos,mouse_click)
    ...
    def start_scene(self) -> None:
        ...
        self.id_input = False
        self.confirm_button = Button(pg.font.Font(None,35).render('confirm',True,(255,255,255),(0,0,0)), 0,0,Transform(0,pg.Vector2(SCREEN_WIDTH/2+100,SCREEN_HEIGHT/2),pg.Vector2(1,0)),lambda : self.action('confirm_button'))
        self.id_button = Button(pg.font.Font(None,35).render(self.txt,True,(255,255,255),(50,50,50)), 0,0,Transform(0,pg.Vector2(SCREEN_WIDTH/2-100,SCREEN_HEIGHT/2),pg.Vector2(1,0)),lambda : self.action('id_button'))
        self.inputbox = InputBox(self.id_button.image,0,0,Transform(0,pg.Vector2(SCREEN_WIDTH/2-100,SCREEN_HEIGHT/2),pg.Vector2(1,0)),self.txt)
