...
class EndScene(Scene):
    ...
    def start_scene(self) -> None:
        ...
        self.scorebox = TextBox(pg.font.Font(None, 40).render(f'Your Score : {self.playerxp}',True,(0,0,0),(0,0,0)), 1,0,Transform(0, pg.Vector2(
            SCREEN_WIDTH/2, SCREEN_HEIGHT/2+100), pg.Vector2(1, 0)), f'Your Score : {self.playerxp}', 40, (0,0,0))
